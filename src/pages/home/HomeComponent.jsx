...
const HeroSection = ({ mousePosition }) => {
  ...
  const service_product = [
    ...
    },
    {
      ...
      description:
        "Enhance your online visiblity, drive more traffic. Check our services today!",
    ...
    },
    {
      ...
      description:
        "Make a lasting impression with our expert web design services that help you make a impact and help you to boost engagement and drive results.",
    ...
    },
    {
      ...
      name: "Cloud Solution",
      description:
        "Scalable cloud solution for secure data management and business growth with our cloud solution services discover the benefit of cloud solution",
      link: "cloud-solution",
      img: product5,
    },
    {
      ...
      description:
        "Connect to world increase your network. Expand your global reach engage and connect with your target audience with our expert digital marketing solution.",
            ...
            <div className="home-hero-content">
              <div className="home-hero-left">
                ...
                <p className="home-hero-description" data-aos="fade-right">
                  Join us to discover the latest advancements in cloud.
                  Computing artificial intelligence, and data analytics and be
        ...
        {/* <div className="home-body-section">
          <section className="unlouck-container">
            <div className="text-center mx-auto unlouck-left">
              <h2 data-aos="zoom-in" className="unlouck-title">
              ...
              <p data-aos="zoom-in" className="unlouck-description fw-normal">
                ...
                where you can connect, collaborate, and foster creativity and
                innovation. Join us to unlock endless possibilities and
                experience the magic of limitless potential!
              </p>
          ...
          <div className="container-home">
            <div className="row-home ">
              {clouddata.map((data, index) => (
                <div
                  className="col-lg-4 home-wrapper-container"
                  key={index}
                  data-aos="fade-right"
          ...
          >
            <h2 id="ai-solutions-title" className="home-section-title-ai pb-5">
            ...
            <div className="home-features-grid" role="list">
              {contentItems.map((item, index) => (
                <div
                  ...
                  role="listitem"
                >
                  <p className="fs-6" style={{ color: "#333" }}>
                    {item}
                  </p>
                </div>
              ))}
